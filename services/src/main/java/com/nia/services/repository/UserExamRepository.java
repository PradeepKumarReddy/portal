...
public interface UserExamRepository extends JpaRepository<UserExam, Long> {
    ...
    @Query("SELECT new com.nia.services.entity.Exam(e.id, e.examDescription, e.examDate, e.examName, e.isActive, ue.totalNoOfQuestions, ue.noOfAnsweredQuestions, ue.username) FROM Exam e LEFT JOIN UserExam ue ON e.id = ue.examId and ue.username=:username order by ue.id desc")
